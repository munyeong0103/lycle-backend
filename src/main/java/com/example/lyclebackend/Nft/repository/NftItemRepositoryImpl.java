...
public class NftItemRepositoryImpl implements CustomNftItemRepository {
    ...
    public FindNftItemDto findNftItemBy(Long nftItemId, Long memberId) {
        return queryFactory
                .select(Projections.bean(FindNftItemDto.class, n.nftItemId, n.nftId, n.collectionName, n.nftItemImg, m.nickname, m.profileImg, n.title, n.createdDate, n.price, n.viewCnt, n.nftItemLikeList.size().as("likeCnt"), n.content, m.memberId.as("sellerId"), m.memberId.eq(memberId).as("isOwner"), n.isDelete, n.status))
                .from(n)
                .leftJoin(n.seller, m)
                .where(n.nftItemId.eq(nftItemId))
                .fetchOne();
